...
wchar_t *author_name     = L"王韵晨";
char *author_name_pinyin = "Wang Yunchen";
unsigned long author_id  = 520370910012;
```
## Description
...
Other common functionalites found in a shell but missing in `mumsh` include:
 ...
 - History trace
## Known Problems
Currently there are none known problems besides ***very ugly code***...   
